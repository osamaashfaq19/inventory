          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title" style='font-size:22px;'>Add Orders</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method='post' action='{{ url("orders/save") }}' id="store_form">
               {{ @csrf_field() }}
                <div class="card-body">
                    ...
                    <div class='col-lg-12'>
                        <table class='table table-bordered order-list'>
                            ...
                            <tbody>
                                <tr>
                                    <td> 
                                        <select class='form-control select2' id='product_id_0' name='product_id[]'>
                                    ...
                                    <td> 
                                        <input type='text' value='' id="quantity_0" placeholder='Enter Quantity' name='quantity[]' class='form-control'  />
                                    </td> 
                                    <td>
                                        <button type='button' data-id='0' class='append_button btn btn-primary btn-sm'><i class='fa fa-plus'></i> </button>
                                        <button type='button' data-id='0'  class='ibtnDel btn btn-danger btn-sm'><i class='fa fa-trash'></i> </button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
