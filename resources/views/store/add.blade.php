          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title" style='font-size:22px;'>Add Store</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method='post' action='save' id="store_form">
               {{ @csrf_field() }}
                <div class="card-body">
                  ...
                  <div class='row'>
                    <div class='col-lg-4'>
                        <div class="form-group">
                            ...
                            <input type="text" name="store_name" id='store_name' class="form-control" placeholder="Enter Store Name">
                        </div>
                    </div>
                    ...
                    <div class='col-lg-4'>
                        <div class="form-group">
                            ...
                            <input type="text" name="store_keeper_name" id='store_keeper_name' class="form-control" placeholder="Enter Store Keeper Name">
                        </div>
                    </div>
